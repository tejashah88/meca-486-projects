...
void setup() {
  ...
  // Z-axis: no limits, full step (200 steps/rev), unused for now
...
void loop() {
  ...
  lcd.clear();
  lcd.setCursor(0, 0);
  lcd.print("Max Speed: "); lcd.print(maxSpeed);
  lcd.setCursor(0, 1);

  trapezoidalMove(&motor, 35, maxSpeed, 2.5f);
  delay(500);
  // trapezoidalMove(&motor, -35, maxSpeed, 2.0f);
  // delay(500);
